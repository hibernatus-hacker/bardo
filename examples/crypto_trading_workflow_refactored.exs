...
try do
  ...
  workflow_config = WorkflowManager.new()
  
  # Print configuration
  WorkflowManager.print_config(workflow_config)
  ...
  # Run the workflow with progress simulation
  WorkflowManager.run(workflow_config, dependencies)
rescue
  e ->
