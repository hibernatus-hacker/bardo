defmodule Bardo.Examples.Applications.FlatlandUtilsTest do
  ...
  describe "world_boundary_intersection/4" do
    test "finds intersection with right boundary" do
      ...
      assert_in_delta x, 10.0, 0.0001
      assert_in_delta y, 0.0, 0.0001
      assert_in_delta t, 10.0, 0.0001
    end
    ...
    test "finds intersection with top boundary" do
      ...
      assert_in_delta x, 5.0, 0.0001
      assert_in_delta y, 0.0, 0.0001
      assert_in_delta t, 5.0, 0.0001
    end
    ...
    test "handles diagonal rays" do
      ...
      # Should hit either right or top boundary (whichever comes first)
      assert (x == 10.0 and y < 10.0) or (y == 10.0 and x < 10.0)
    end
  end
end