defmodule Bardo.PopulationManager.PopulationManager do
  ...
  def calculate_specie_fitness(specie_id) do
    ...
    case fitness_acc do
      [] ->
        {[], [], [], :inf}
      [average_fitness] ->
        {[average_fitness], [average_fitness], [average_fitness], :inf}
      _ ->
  ...
  defp calculate_avg_nodes([], n_acc) do
    {Functions.avg(n_acc), Functions.std(n_acc)}
  end
  ...
  defp vector_basic_stats(vector_list) do
    ...
    {max_vector, min_vector, avg_vector, std_vector}
  end
  ...
  @doc false
  def do_evaluations(pop_id, step_size, specie_id, aea, agent_cycle_acc, agent_time_acc, op_modes, evo_alg, state) do
    do_evaluations(pop_id, step_size, specie_id, aea, agent_cycle_acc, agent_time_acc, op_modes, evo_alg, state)
  end

  @doc false
  def do_termination_generational(pop_id, agent_id, params, op_modes, state) do
    do_termination_generational(pop_id, agent_id, params, op_modes, state)
  end

  @doc false
  def do_termination_steady_state(pop_id, agent_id, params, op_modes, state) do
    do_termination_steady_state(pop_id, agent_id, params, op_modes, state)
  end

  @doc false
  def do_termination_generational_continue(pop_id, params, op_modes, state) do
